package ru.gonchar17narod.selferificator.ui.custom_views;
...
public class FrequencyView extends View {
    ...
    public void onDraw(Canvas canvas) {
        int[] colors = null;
        String colorScale = getContext().getString(R.string.preferences_color_scale_default_value);
		...
		String defFrequency = getContext().getString(R.string.preferences_frequency_scale_default_value);
